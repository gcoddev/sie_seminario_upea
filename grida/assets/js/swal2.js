!(function(t, e) {
			...
			e.buttonsStyling
				? (function(t, e, n) {
						...
						n.cancelButtonColor && (e.style.backgroundColor = n.cancelButtonColor);
						{
							var o;
							R() ||
								((o = window.getComputedStyle(t).getPropertyValue('background-color')),
	...
	function Pt(t, e) {
		...
		l &&
			...
			!e.backdrop &&
				e.allowOutsideClick &&
				_('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
			(i = l),
			(r = e.position) in Y
				? mt(i, Y[r])
				: (_('The "position" parameter is not valid, defaulting to "center"'), mt(i, Y.center)),
			(a = l),
	...
	var Dt = function() {
		...
		zt = function(t, e) {
			(t.className = ''.concat(Y.popup, ' ').concat(vt(t) ? e.showClass.popup : '')),
				e.toast
					? (mt([ document.documentElement, document.body ], Y['toast-shown']), mt(t, Y.toast))
					: mt(t, Y.modal),
				N(t, e, 'popup'),
	...
	function Jt(t) {
		for (var e in t)
			Qt((i = e)) || _('Unknown parameter "'.concat(i, '"')),
				t.toast &&
					((o = e), -1 !== ne.indexOf(o) && _('The parameter "'.concat(o, '" is incompatible with toasts'))),
				$t((n = e)) && g(n, $t(n));
		var n, o, i;
	}
	var Xt = {},
	...
	var se = function() {
			navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) ||
				($().scrollHeight > window.innerHeight - 44 && (Q().style.paddingBottom = ''.concat(44, 'px')));
		},
		ue = function() {
			var e,
				t = Q();
		...
		ze = function(t, e, n) {
			...
			o.stopKeydownPropagation && e.stopPropagation(),
				'Enter' === e.key
					...
					: 'Tab' === e.key
						? Ke(e, o)
						: -1 !== _e.indexOf(e.key) ? Ye() : -1 !== Fe.indexOf(e.key) && Ze(e, o, n);
		},
		We = function(t, e, n) {
			...
			if (!e.toast)
				return W(e.allowEnterKey)
					? e.focusCancel && vt(t.cancelButton)
						...
						: e.focusConfirm && vt(t.confirmButton) ? t.confirmButton.focus() : void Ee(0, -1, 1)
					: nn();
		},
		nn = function() {
