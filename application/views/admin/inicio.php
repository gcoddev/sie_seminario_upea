...
<section class="content">
	<div class="row">
		<div class="col-xl-8 col-12">
					...
					<div class="flex-grow-1 p-30 flex-grow-1 bg-img dask-bg bg-none-md" style="background-position: right bottom; background-size: auto 100%; background-image: url(https://www.multipurposethemes.com/admin/eduadmin-template/images/svg-icon/color-svg/custom-1.svg)">
						<div class="row">
							<div class="col-12 col-xl-7">
								...
								<h2>Bienvenido, <strong><?php echo $user->first_name ?></strong></h2>
			...
			<?php if ($seminarios) : ?>
				<?php foreach ($seminarios as $val) : ?>
					<div class="row">
						<div class="col-xl-6">
							<div class="box">
								<div class="box-body d-flex p-0">
									<div class="flex-grow-1 bg-danger p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 100%; background-image: url(<?= base_url($val->imagen)  ?>)">

										<h4 class="font-weight-400"><?= $val->descripcion ?></h4>

								

										<a href="<?= base_url(hasher::make(66, $val->id_capacitacion)) ?>" class="btn btn-danger-light">VER REGISTROS EN EL SEMINARIO</a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="box bg-transparent no-shadow mb-0">
				<div class="box-header no-border">
					<h4 class="box-title">Inscritos en el seminario</h4>
