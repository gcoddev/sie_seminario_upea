...
class Ion_auth
{
	...
	///seguro filyboy
	public function is_seguro_social($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('seguro_social');

		$seguro_social_group = $this->config->item('seguro_social_group', 'ion_auth');

		return $this->ion_auth_model->in_group($seguro_social_group, $id);
	}
