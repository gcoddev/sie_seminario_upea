...
//        $this->SetFont('monotypecorsiva', 'B', 23);
   ...
   return $diasmes;
    ...
    function Footer() {
        ...
        $this->SetDrawColor(210,211,211);
        $this->SetTextColor(128);
        // $this->Cell(80,8,'http://sysoftbo.com','T',0,'L');
        // $this->Cell(50,8,'@JF:'.date('d/m/Y H:i:s'),'T',0,'C');

        $this->SetFont('times', 'I',6);
        $this->Ln();
        $this->Cell(280, 5, 'Av. Sucre A s/n Zona Villa Esperanza  --- JC : '.date('d/m/Y H:i:s'), '0', 0, 'L');
        // $this->Cell(60, 5, ' Pag. ' . $this->PageNo() . '', 'T', 0, 'R');
        // $this->ln(5);
